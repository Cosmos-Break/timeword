    ...
    for line in data:
        ...
        for word in words:
            if "/t" not in word:
                ...
                length = len(word)
                if length == 1:
                    crfFormat.append(word[0] + " " + "S" + " " + "S" + " S" + " O" + "\n")
                elif length == 2:
                    crfFormat.append(word[0] + " " + "B" + " " + "B" + " B" + " O" + "\n")
                    crfFormat.append(word[1] + " " + "E" + " " + "E" + " E" + " O" + "\n")
                elif length >= 3:  # length >= 3
                    crfFormat.append(word[0] + " " + "B" + " " + "B" + " B" + " O" + "\n")
                    for i in range(1, length - 1):
                        crfFormat.append(word[i] + " " + "M" + " " + "M" + " M" + " O" + "\n")
                    crfFormat.append(word[length - 1] + " " + "E" + " " + "E" + " E" + " O" + "\n")

            else:  # 是时间词
                word = word.split('/')[0]
                length = len(word)
                if length == 1:
                    crfFormat.append(word[0] + " " + "S" + " " + "S" + " S" + " TS" + "\n")
                elif length == 2:
                    crfFormat.append(word[0] + " " + "B" + " " + "B" + " B" + " TB" + "\n")
                    crfFormat.append(word[1] + " " + "E" + " " + "E" + " E" + " TE" + "\n")
                elif length >= 3:  # length >= 3
                    crfFormat.append(word[0] + " " + "B" + " " + "B" + " B" + " TB" + "\n")
                    for i in range(1, length - 1):
                        crfFormat.append(word[i] + " " + "M" + " " + "M" + " M" + " TM" + "\n")
                    crfFormat.append(word[length - 1] + " " + "E" + " " + "E" + " E" + " TE" + "\n")
            if word == "。" or word == "，":
                crfFormat.append("\n")
        crfFormat.append("\n")
    return crfFormat
...
f = open("CONLL_test.pos-chunk-name", 'w', encoding='utf-8', newline='\n')
for a in crfTestSet:
    f.write(a)
f.close()
f = open("CONLL_train.pos-chunk-name", 'w', encoding='utf-8', newline='\n')
for a in crfTrainSet:
    f.write(a)
f.close()
f = open("CONLL_dev.pos-chunk-name", 'w', encoding='utf-8', newline='\n')
for a in crfDevSet:
    f.write(a)
f.close()
